...
MemCheck_RAM_Error_wait:
 ld hl,$0000                            ; T=10, 2.50탎@4MHz
 dec de                                 ; T=6, 1.50탎@4MHz
 sbc hl,de                              ; T=15, 3.75탎@4MHz
 jr nz,MemCheck_RAM_Error_wait          ; T=7, 1.75탎@4MHz
...
.org $2200
;*****************THIS SUBROUTINE WORKS !!!!
Delay: ; de=input value --> 14.50 탎 / cycle
 dec de         ; T=6 , 1.50
 ld a,d         ; T=4 , 1.00
 cp $FF         ; T=7 , 1.75
